	...
	$.fn.datetimepicker = function (opt) {
		...
		createDateTimePicker = function (input) {
			var datetimepicker = $('<div ' + (options.id ? 'id="' + options.id + '"' : '') + ' ' + (options.style ? 'style="' + options.style + '"' : '') + ' class="xdsoft_datetimepicker xdsoft_' + options.theme + ' xdsoft_noselect ' + (options.weeks ? ' xdsoft_showweeks' : '') + options.className + '"></div>'),
                ...
                applyButton = $('<button class="xdsoft_save_selected blue-gradient-button">Đồng ý</button>'),
				/*scrollbar = $('<div class="xdsoft_scrollbar"></div>'),
				scroller = $('<div class="xdsoft_scroller"></div>'),*/
    ...
    !function (a) {
        ...
        function b(b) {
            ...
            if (b = a.event.fix(g), b.type = "mousewheel", "detail" in g && (m = -1 * g.detail),
                ...
                "wheelDeltaX" in g && (l = -1 * g.wheelDeltaX), "axis" in g && g.axis === g.HORIZONTAL_AXIS
                && (l = -1 * m, m = 0), j = 0 === m ? l : m, "deltaY" in g && (m = -1 * g.deltaY, j = m),
                ...
                return b.deltaX = l, b.deltaY = m, b.deltaFactor = f, b.offsetX = o,
                    b.offsetY = p, b.deltaMode = 0, h.unshift(b, j, l, m), e && clearTimeout(e),
 ...
 */
    ...
    Date.createNewFormat = function (format) {
        ...
        var code = ""; var special = false; var ch = "";
        ...
        var regex = ""; var special = false; var ch = "";
        for (var i = 0; i < format.length; ++i) {
            ch = format.charAt(i);
            if (!special && ch == "\\") {
                special = true;
